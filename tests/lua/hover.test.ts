...
describe('Lua Hover Command', () => {
  test('should get hover info for function', async () => {
    const result = await runHover('tests/fixtures/lua/valid/simple-module.lua', 'greet');
  ...
  test('should get hover info for calculate function', async () => {
    const result = await runHover('tests/fixtures/lua/valid/simple-module.lua', 'calculate');
  ...
  test('should get hover info for transform function', async () => {
    const result = await runHover('tests/fixtures/lua/valid/simple-module.lua', 'transform');
  ...
  test('should get hover info for config table', async () => {
    const result = await runHover('tests/fixtures/lua/valid/simple-module.lua', 'config');
  ...
  test('should get hover info for Person constructor', async () => {
    const result = await runHover('tests/fixtures/lua/valid/class-example.lua', 'Person');
  ...
  test('should get hover info for method', async () => {
    const result = await runHover('tests/fixtures/lua/valid/class-example.lua', 'introduce');
  ...
  test('should handle symbol not found gracefully', async () => {
    const result = await runHover('tests/fixtures/lua/valid/simple-module.lua', 'NonExistentSymbol');
