...
describe('JavaScript Hover Command', () => {
  test('should get hover info for function', async () => {
    const result = await runHover('tests/fixtures/javascript/valid/simple-module.js', 'add');
  ...
  test('should get hover info for another function', async () => {
    const result = await runHover('tests/fixtures/javascript/valid/simple-module.js', 'greet');
  ...
  test('should get hover info for constant', async () => {
    const result = await runHover('tests/fixtures/javascript/valid/simple-module.js', 'PI');
  ...
  test('should handle symbol not found gracefully', async () => {
    const result = await runHover('tests/fixtures/javascript/valid/simple-module.js', 'NonExistentSymbol');
